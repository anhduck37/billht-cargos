...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('order/import-smart', 'SmartImportController@index')->name('orders.smartImport.index');
    Route::post('order/import-smart/preview', 'SmartImportController@preview')->name('orders.smartImport.preview');
    Route::get('order/import-smart/{batch}', 'SmartImportController@show')->name('orders.smartImport.show');
    Route::post('order/import-smart/{batch}/confirm', 'SmartImportController@confirm')->name('orders.smartImport.confirm');
    Route::post('order/import-smart/{batch}/rows/{row}', 'SmartImportController@updateRow')->name('orders.smartImport.rows.update');
    Route::post('order/import-smart/{batch}/delete', 'SmartImportController@destroy')->name('orders.smartImport.destroy');
