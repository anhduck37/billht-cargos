...
{{--                </div>--}}
        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                    <label for="validationDefault02">Tình trạng đơn hàng</label>
        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    <label for="validationDefault01">Giá trị đơn hàng</label>
                    <input type="text" class="form-control" name="order[total]" value="{{old('order.total') ? old('order.total') : $order->total}}" placeholder="Giá tị đơn hàng">
                </div>
            </div>
        </div>
        <div class="form-group">
