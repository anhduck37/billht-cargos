    ...
    <div class="container-fluid mt--4">
        <div class="row mt-5">
            <div class="col-xl-12 mb-5 mb-xl-0">
                ...
                <!-- Modal Print -->
                <div class="modal fade" id="openModalPrint" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="false">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body" id="loading">
                                ...
                                <div class="form-check isShow">
                                    <input class="form-check-input" type="radio" name="number" id="number_3_copies" value="3">
                                    <label class="form-check-label" for="number_3_copies">
                                        3 liên
                                    </label>
                                </div>
                                <div class="form-check isShow">
