            ...
            <div class="row mt-2">
                <div class="col">
                    <div class="card-body">
                        ...
                        <p class="card-text">{{isset($order->sender) ? $order->sender->sender_name : '.....'}}</p>
                        <p class="card-text"><small class="text-muted">{{isset($order->sender) ? $order->sender->address . ', ' . (isset($order->sender->ward) ? $order->sender->ward->ward_name : '') . ', ' . (isset($order->sender->district) ? $order->sender->district->district_name : '') . ', ' . (isset($order->sender->city) ? $order->sender->city->city_name : '') : '.....'}} </small></p>
                        <p class="card-text"><b>Điện thoại:</b> {{isset($order->sender) ? $order->sender->sender_phone : '.....'}}</p>
                    </div>
                </div>
                <div class="col">
                    <div class="card-body">
