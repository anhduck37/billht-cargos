...
class SendSMSService {
    ...
    public function sendSMS($phone, $content=null, $order, $isSend=false) {
        ...
        if($content) {
            ...
            $this->data['Content'] = 'HTExpress Xin chao QK. Chung toi dang thuc hien giao hang cho QK. Theo doi tai day: ' . route('tracking', ['order_code' => $order->order_code]) . ' Lien he: 1900633656';
