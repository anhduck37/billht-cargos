...
class ViettelPostService
{
    ...
    public function createOrder($order)
    {
        ...
        if (empty($formatData['ORDER_SERVICE'])) {
            $result = [
                'error' => true,
                'message' => 'Chưa xác định được dịch vụ Viettel Post. Vui lòng chọn Dịch vụ trong nước (Chuyển phát nhanh hoặc Tiết kiệm), kiểm tra trọng lượng và đẩy lại.',
                'data' => []
            ];
